...
<cfscript>
	writeOutput("<script src='javascripts/calendar.functions.js'></script>");
</cfscript>
				...
				<table id="birthdays" class="social" bgcolor="" border=1>
					<tr>
						<td class="container">
								...
								<div class="content">
									<table border=0>
									<tr id="birthdayBlock"><th colspan=2 id="birthday_title">Masonic Birthdays for #DateFormat("#getBirthdays.current_date#","mmmm")#</th></tr>
</cfoutput>
<cfscript>
