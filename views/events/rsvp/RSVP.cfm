...
<cfswitch expression="#url.pass#">
  ...
  <cfcase value="1"><!--- First pass --->
	...
	<SCRIPT LANGUAGE="JavaScript">		
  	...
  	<div align="center"><img src="images/Helmet2015.jpg"  alt="Knights Helmet"></div>
	...
	<cfelse>
		...
		<div class="row">
			<div class="twelve mobile-four centered columns">
				...
				"Knight to Remember VIII" <br>Medieval Table Lodge at Philo Lodge.</h5><br>
				...
				<cfset attending = #form.num_attending#*25>
		...
		subject="Knight to Remember VIII Medieval Table Lodge at Philo - RSVP Confirmation">
   		<cfmailpart type="text" wraptext="74">
Knight to Remember Table Lodge Confirmation
Thank-you brother #form.lname# for registering for the "Knight to Remember VIII" Medieval Table Lodge at Philo.
...
Table Lodge Dinner: 6:30 PM
		...
		<br />
		Thank-you brother #form.lname# for registering for the "Knight to Remember VIII" Medieval Table Lodge at Philo.<br />
